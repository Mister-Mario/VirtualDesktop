            ...
            getPrevision(){
                ...
                $.ajax({
                            ...
                            success: function(datos){
                                ...
                                $("main").append("<section data-type=pronostico><h3>Pronostico</h3></section>")
                                for(let i = 0; i < 40; i+= 8){
                                    ...
                                    var rain = weather.rain == undefined ? 0 : weather.rain['3h'];
                                    
                                    $("section[data-type='pronostico']").append("<section data-i = "+ i +" data-type=tiempo></section>");
                                    $("section[data-i = '" + i +"'][data-type='tiempo']").append("<h4>Día: " + (i/8 + 1) +"</h4><img src=" + icon + " alt= 'Icono que representa el pronostico del tiempo'/>")
                                        .append("<section data-i = "+ i +" data-type=datos></section>");
                                    $("section[data-i = '" + i +"'][data-type='datos']").append("<h4>" + fecha +"</h4>")
