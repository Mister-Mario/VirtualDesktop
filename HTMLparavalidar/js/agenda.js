...
class Agenda{
    ...
    paintInformation(){
        ...
        $("section[data-type='carreras']").append("<h3>Carreras</h3>");
        $("Race", this.last_api_result).each((index, race) =>{
            $("section[data-type='carreras']").append("<section data-type = 'carrera' data-i ='" + index + "' lang='en'></section>");
            $("section[data-i = '"+ index +"'")
                .append("<h4>"+  $("RaceName",race).text() +"</h4>")
